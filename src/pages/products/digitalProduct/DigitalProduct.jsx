...
import EditDigitalProdModal from "../addproduct/addDigitalProduct/EditDigitalProdModal";
    ...
    <div className="responsive-table-container">
      <div className="single-widget table">
        <div className="table-top-header">
          <div className="table-title">Digital Products</div>
      ...
      <EditDigitalProdModal setOpen={setEditModal} open={editModal} />
    </div>
  );
};
